        ...
        <div class="max-w-7xl mx-auto w-full flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                ...
                <form action="#" method="POST">
                    <button class="text-xs font-bold uppercase text-gray-400 hover:text-red-500 transition">Logout</button>
                </form>
            </div>
        </div>
    </nav>
    ...
    <div class="max-w-md w-full text-center">
        ...
        <div class="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-indigo-100/50 border border-gray-100">
            ...
            <p class="text-gray-500 text-sm leading-relaxed mb-10">
                EasyColoc helps you track expenses and manage bills with your roommates. Start your journey by creating a new home or joining one you were invited to.
            </p>

            <div class="space-y-4">
                <button class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-4 rounded-2xl shadow-lg shadow-indigo-200 transition-all transform hover:-translate-y-1">
                    Create Colocation
                </button>

                <button class="w-full bg-white border-2 border-gray-100 hover:border-indigo-100 hover:bg-indigo-50/30 text-gray-700 font-bold py-4 rounded-2xl transition-all">
                    Join via Invitation
                </button>
            </div>
