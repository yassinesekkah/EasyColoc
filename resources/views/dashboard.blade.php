    ...
    <main class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <div class="flex items-center mt-1 space-x-3">
                            <span class="px-2.5 py-0.5 rounded-full text-xs font-medium bg-indigo-100 text-indigo-800">Owner</span>
                            <span class="text-sm text-gray-500">Reputation: <span class="font-bold text-gray-700">98%</span></span>
                        </div>
                    </div>
                    <button class="inline-flex items-center px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-semibold rounded-xl transition shadow-md shadow-indigo-200">
            ...
            <div class="flex flex-wrap gap-3">
                <button class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition">Invite Member</button>
                <button class="px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-xl hover:bg-gray-50 transition">Manage Categories</button>
                <button class="px-4 py-2 bg-red-50 border border-red-100 text-red-600 text-sm font-medium rounded-xl hover:bg-red-100 transition">Cancel Colocation</button>
            </div>
            {{-- @endif --}}
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <p class="text-3xl font-bold text-gray-900 mt-1">{{$currentBalance}} MAD</p>
            </div>
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <ul class="divide-y divide-gray-50">
                        <li class="p-6">
                            ...
                            <button class="w-full py-2 bg-gray-50 text-indigo-600 text-xs font-bold uppercase tracking-widest rounded-lg hover:bg-indigo-600 hover:text-white transition">
                                Mark as Paid
                            </button>
                        </li>
                        <li class="p-6">
                            ...
                            <button class="w-full py-2 bg-gray-50 text-gray-400 text-xs font-bold uppercase tracking-widest rounded-lg cursor-not-allowed" disabled>
                                Awaiting Approval
                            </button>
                        </li>
                    </ul>
            ...
            <div class="lg:col-span-2">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <table class="w-full text-left">
                            ...
                            <tbody class="divide-y divide-gray-100">
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1 text-xs bg-blue-50 text-blue-600 rounded-md">Utilities</span>
                                    </td>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1 text-xs bg-green-50 text-green-600 rounded-md">Household</span>
                                    </td>
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        <span class="px-2 py-1 text-xs bg-yellow-50 text-yellow-600 rounded-md">Food</span>
                                    </td>
                    ...
                    <div class="p-4 bg-gray-50 text-center">
                        <a href="#" class="text-sm font-semibold text-indigo-600 hover:text-indigo-800">View all expenses</a>
                    </div>
                </div>
            </div>
        </div>
